...
export class Default1696356443820 implements MigrationInterface {
    name = 'Default1696356443820'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "bikes" ("id" SERIAL NOT NULL, "size" character varying(10) NOT NULL, "gender" "public"."bikes_gender_enum" NOT NULL, "gear" character varying(10) NOT NULL, "rim" double precision NOT NULL, "suspension" boolean NOT NULL, "description" character varying(200) NOT NULL, "hourlyvalue" numeric(10,2) NOT NULL, "dailyvalue" numeric(10,2) NOT NULL, "idbrand" integer NOT NULL, "idmaterial" integer NOT NULL, "idaddress" integer NOT NULL, "iduser" integer NOT NULL, CONSTRAINT "PK_5237c1fcb162998a0d31e640814" PRIMARY KEY ("id"))`);
